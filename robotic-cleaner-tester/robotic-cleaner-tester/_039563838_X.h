#ifndef _039563838_X_h__
#define _039563838_X_h__
...
class _039563838_X :	public AbstractAlgorithm
{
...
public:
	_039563838_X(void);
	_039563838_X(const AbstractSensor& sensor, map<string, int> config);
	~_039563838_X(void);
...
}; // end of class _039563838_X

inline void _039563838_X::setSensor(const AbstractSensor& sensor) 
{
	_robotSensor = &sensor;
}

inline void _039563838_X::setConfiguration(map<string, int> config)
{
...
//inline bool _039563838_X::IsInDocking() const
//{
//	return (_pathFromDocking.size() == 0);
//}

#endif // _039563838_X_h__
