...
//************************************
Direction _039563838_B::step(Direction lastStep)
{
	if(_debug) {
...
Direction _039563838_B::Handle_Returning_State(Direction lastStep){
	if(_debug)	cout << "Handle_Returning_State step number: " << totalSteps << endl;
	int remainingSteps = GetRemainingSteps();
	if(_debug) 
		cout << " _039563838_B::Handle_Returning_State\tremainingSteps: " << remainingSteps << endl;
...
int _039563838_B::GetRemainingSteps()
{
...
Direction _039563838_B::Handle_Cleaning_State(Direction lastStep)
{
	if(_debug)	cout << "Handle_Cleaning_State step number: " << totalSteps << endl;
	int remainingSteps = GetRemainingSteps();
	if(_debug) 
		cout << " _039563838_B::Handle_Cleaning_State\tremainingSteps: " << remainingSteps << endl;
...
bool _039563838_B::CheckUnexploredPointsReachability()
{
...
Direction _039563838_B::Handle_Explore_State()
{
...
int _039563838_B::GetPathTotalCleaning(const Path & path) const
{
	int score  = 0;
...
Path _039563838_B::GetBestPathToDocking(const deque<Path> & pathsToDocking)
{
...
Path _039563838_B::GetSPToDocking()
{
	if(_debug) 
...
deque<Path> _039563838_B::GetSPToUnexplored(bool fromDocking /* = false */)
{
...
void _039563838_B::aboutToFinish(int stepsTillFinishing)
{
...
void _039563838_B::UpdateAlgorithmInfo(Direction lastStep) 
{
	if(_aboutToFinishWasCalled)
		--_stepsTillFinishing;
...
void _039563838_B::UpdateNeighboors(SensorInformation s){
...
bool _039563838_B::CheckAllExplored(){
    for ( const auto &pointInfoPair : houseMapping) 
    {
        if(pointInfoPair.second.isUnexplored())
        	return false;
...
bool _039563838_B::CheckAllCleaned(){
    for ( const auto &pointInfoPair : houseMapping) 
    {
...
void _039563838_B::UpdateDirt(CellInfo & oldInfo, int newDirtLevel)
{
...
void _039563838_B::UpdateInMap(GeneralizedPoint point, CellInfo newInfo)
{
...
//for debug:
void _039563838_B::printDebugHouseMapping() 
{
...
//for debug
void _039563838_B::PrintAlgorithmStatus()
{
